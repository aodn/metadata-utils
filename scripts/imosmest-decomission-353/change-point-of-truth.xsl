...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template match="gmd:distributionInfo//gmd:CI_OnlineResource[ gmd:linkage/gmd:URL[ matches( text(), 'https://catalogue-imos.aodn.org.au') and not(matches( text(), 'https://catalogue-imos.aodn.org.au:443'))] ]/gmd:linkage/gmd:URL/text()">
        <xsl:value-of select='replace(., "https://catalogue-imos.aodn.org.au", "https://catalogue-imos.aodn.org.au:443")'/>
    </xsl:template>
